parents_of(elizabeth-ii, george-vi, elizabeth).
parents_of(margaret, george-vi, elizabeth).

parents_of(charles, philip, elizabeth-ii).
parents_of(anne, philip, elizabeth-ii).
